class FileUpload < ActiveRecord::Base
  ...
  if Rails.env.production?
    path = "/var/www/sites/dumplings/current/assets/uploads/img/:user_id/:id/:style/:basename.:extension"
  else
    path = ":rails_root/app/assets/uploads/img/:user_id/:id/:style/:basename.:extension"
  end

  has_attached_file :upload, :styles => {:thumb => "50x50#", :medium => "300x300>" },
                    path: path,
                    url:  "/assets/uploads/img/:user_id/:id/:style/:basename.:extension"
